...
public class SpringFoxConfig {
    ...
    GroupedOpenApi publicApi() {
        return GroupedOpenApi.builder()
                .group(Constant.ADMIN_TITLE_GROUP_API)
    ...
    OpenAPI springShopOpenAPI() {
        return new OpenAPI()
                .info(new Info().title(Constant.ADMIN_TITLE_API)
                        .description(Constant.ADMIN_DESCRIPTION_API)
                        .version(Constant.ADMIN_VERSION_API)
                        .contact(contact())
