...
public class SpringFoxConfig {
    ...
    GroupedOpenApi publicApi() {
        return GroupedOpenApi.builder()
                .group(Constant.USER_TITLE_GROUP_API)
    ...
    OpenAPI springShopOpenAPI() {
        return new OpenAPI()
                .info(new Info().title(Constant.USER_TITLE_API)
                        .description(Constant.USER_DESCRIPTION_API)
                        .version(Constant.USER_VERSION_API)
                        .contact(contact())
